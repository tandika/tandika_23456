...
public class form_data_barang extends javax.swing.JFrame {
    ...
    private JasperFillManager JasPri;
    private Action report1;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA SPAREPART MOTOR");
        ...
        c_thn.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tahun", "2022", "2021", "2020", "2019", "2018", "2017", "2016", "2015", "2014" }));
...
System.exit(0);        // TODO add your handling code here:
 ...
 try {
    ...
    JasperPrint jprintt = JasperFillManager.fillReport(jreprt,null,new koneksi_mysql().koneksi());
  ...
  JOptionPane.showMessageDialog(null, "Gagal Membuka Laporan","Cetak Laporan",JOptionPane.ERROR_MESSAGE);
    ...
    private void CallReportJRMXL() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    private Connection koneksi_mysql() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
